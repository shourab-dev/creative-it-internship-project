            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        ...
                        <h4 class="my-1">{{ $totalSales }} tk</h4>
    ...
    <div class="col">
        <div class="card radius-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <p class="mb-0 text-secondary">Total Sales Quantity</p>
                        <h4 class="my-1">{{ $totalSalesQty }}</h4>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="">
                                            <img src="{{ asset('backend/assets/images/avatars/avatar-12.png') }}"
                                                class="rounded-circle" width="46" height="46" alt="" />
                                        </div>
                                        <div class="ms-2">
                                            <h6 class="mb-1 font-14">Payment from Lewis Cruz</h6>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="">
                                            <img src="{{ asset('backend/assets/images/avatars/avatar-13.png') }}"
                                                class="rounded-circle" width="46" height="46" alt="" />
                                        </div>
                                        <div class="ms-2">
                                            <h6 class="mb-1 font-14">Payment from David Buckley</h6>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="">
                                            <img src="{{ asset('backend/assets/images/avatars/avatar-14.png') }}"
                                                class="rounded-circle" width="46" height="46" alt="" />
                                        </div>
                                        <div class="ms-2">
    ...
    <div class="col d-flex">
        <div class="card radius-10 w-100">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Women <span
        ...
        <div class="card radius-10 w-100">
            ...
            <div class="customers-list p-3 mb-3">
                <div class="customers-list-item d-flex align-items-center border-top border-bottom p-2 cursor-pointer">
                    <div class="">
                        <img src="{{ asset('backend/assets/images/avatars/avatar-3.png') }}" class="rounded-circle"
                ...
                <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                    <div class="">
                        <img src="{{ asset('backend/assets/images/avatars/avatar-4.png') }}" class="rounded-circle"
                            width="46" height="46" alt="" />
                    </div>
                    <div class="ms-2">
                ...
                <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                    <div class="">
                        <img src="{{ asset('backend/assets/images/avatars/avatar-23.png') }}" class="rounded-circle"
                            width="46" height="46" alt="" />
                    </div>
                    <div class="ms-2">
                ...
                <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                    <div class="">
                        <img src="{{ asset('backend/assets/images/avatars/avatar-24.png') }}" class="rounded-circle"
                            width="46" height="46" alt="" />
                    </div>
                    <div class="ms-2">
                ...
                <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                    <div class="">
                        <img src="{{ asset('backend/assets/images/avatars/avatar-20.png') }}" class="rounded-circle"
                            width="46" height="46" alt="" />
                    </div>
                    <div class="ms-2">
                ...
                <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                    <div class="">
                        <img src="{{ asset('backend/assets/images/avatars/avatar-16.png') }}" class="rounded-circle"
                            width="46" height="46" alt="" />
                    </div>
                    <div class="ms-2">
                ...
                <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                    <div class="">
                        <img src="{{ asset('backend/assets/images/avatars/avatar-25.png') }}" class="rounded-circle"
                            width="46" height="46" alt="" />
                    </div>
                    <div class="ms-2">
                ...
                <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                    <div class="">
                        <img src="{{ asset('backend/assets/images/avatars/avatar-11.png') }}" class="rounded-circle"
                            width="46" height="46" alt="" />
                    </div>
                    <div class="ms-2">
                ...
                <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                    <div class="">
                        <img src="{{ asset('backend/assets/images/avatars/avatar-17.png') }}" class="rounded-circle"
                            width="46" height="46" alt="" />
                    </div>
                    <div class="ms-2">
                ...
                <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                    <div class="">
                        <img src="{{ asset('backend/assets/images/avatars/avatar-7.png') }}" class="rounded-circle"
                            width="46" height="46" alt="" />
                    </div>
                    <div class="ms-2">
